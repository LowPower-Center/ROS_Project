...
point1 = [(11.1700, 1.80, 0.393328), (0.000, 0.000, 1.59)]
...
class Excavator():
    ...
    def data_transfer(self, fl_name):
        ...
        filename = '/home/sunchen/jidian/src/modelfile/pudong_gazebo/scripts/waypoint_dates/' + fl_name
        dates = []
    ...
    def list_command(self):
        ...
        # 一次挖掘完后放置,慢速旋转0.015
        self.single_joint_positions_command(81, -23, -3, 53, max_vel=1.0)
        self.single_joint_positions_command(81, -8, -5, -42, max_vel=1.0)
        self.single_joint_positions_command(81, -18, -21, 8)
